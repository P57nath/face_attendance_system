...
class CaptureApp:
    def __init__(self, root):
        ...
        self.PIPELINE = (
            f"libcamerasrc ! video/x-raw,format=RGB,width={WIDTH},height={HEIGHT},framerate={FPS}/1 ! "
    ...
    def update_video(self):
        ...
        if ok:
            ...
            faces = self.face_cascade.detectMultiScale(gray, 1.2, 5, minSize=(80,80))
             #faces = self.face_cascade.detectMultiScale(gray, scaleFactor=1.15, minNeighbors=4,minSize=(80, 80),flags=cv2.CASCADE_SCALE_IMAGE)
